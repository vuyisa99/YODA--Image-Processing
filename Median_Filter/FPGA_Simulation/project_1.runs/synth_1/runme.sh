...
HD_PWD='C:/Users/Vuyisa Mpetsheni/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_median_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_median_filter.tcl
